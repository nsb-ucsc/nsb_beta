...
#ifndef __INET_NSBBASICAPP_H
#define __INET_NSBBASICAPP_H
 ...
 */
class INET_API nsbBasicApp : public ClockUserModuleMixin<ApplicationBase>, public UdpSocket::ICallback
{
  protected:
